...
import { Search, Lock, MapPin, Star, Filter } from 'lucide-vue-next';
  ...
  <SiteLayout>
    <div class="mx-auto max-w-7xl px-4 sm:px-6 py-8 pb-28 md:pb-12">
        ...
        <div class="flex gap-2">
          <div class="relative flex-1 md:w-72">
            ...
            <input 
              ...
              class="w-full h-11 pl-10 pr-3 rounded-xl bg-gaming-darker/80 border border-electric/30 text-sm text-white focus:border-electric focus:shadow-neon outline-none transition-all" 
            />
          </div>
      ...
      <div class="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <img 
            :src="c.image_path || '/images/city-placeholder.jpg'" 
            :alt="c.name" 
            loading="lazy"
