...
import {
    Brain, Plus, Trash2, Edit2, ChevronLeft,
    Clock, Zap
...
// Modal de confirmation de Question
    ...
    <SiteLayout>
        <div class="mx-auto max-w-7xl px-4 sm:px-6 py-10 pb-28 md:pb-12">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        <div class="text-xs text-purple-neon uppercase tracking-[0.2em] font-black mb-1">
                            Éditeur de Défis
                        </div>
            ...
            <div class="space-y-8">
                <div v-for="quiz in city.quizzes" :key="quiz.id"
                    ...
                    <div class="p-8 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/5">
                        <div class="flex items-start gap-5">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-4 mt-2">
                                    <span class="text-[10px] px-2 py-1 rounded bg-white/5 text-muted-foreground uppercase font-bold tracking-tighter">
                                        {{ quiz.category }}
                                    </span>
                        ...
                        <div class="flex gap-2">
                            ...
                            <button @click="prepareDelete(quiz.id)"
                                ...
                                <tr v-for="q in quiz.questions" :key="q.id" class="border-b border-white/5 hover:bg-white/5 transition-all">
                                    ...
                                    <td class="p-4">
                                        <div class="flex items-center gap-2">
                                            <div class="h-6 w-6 rounded bg-success/20 border border-success/40 grid place-items-center text-success text-[10px] font-bold">
                                                {{ q.correct_option }}
                                            </div>
                                    ...
                                    <td class="p-4 text-right">
                                        <div class="flex justify-end gap-2">
                                            ...
                                            <button @click="prepareDeleteQuestion(q.id)"
                ...
                <div v-if="!city.quizzes?.length" class="p-20 text-center glass-strong rounded-[3rem] border border-white/5">
                    ...
                    <p class="text-muted-foreground mt-2 max-w-sm mx-auto">
                        Commencez par créer un quiz pour tester les connaissances des explorateurs dans cette ville.
                    </p>
                </div>
            </div>
        </div>
        ...
        <Modal :show="showQuizModal" @close="showQuizModal = false">
            <div class="p-8 bg-gaming-darker border border-purple-neon/20 rounded-[2.5rem] overflow-hidden relative">
                ...
                <h2 class="font-display text-2xl text-foreground mb-8 relative z-10">
                    {{ editingQuiz ? 'Modifier le Quiz' : 'Nouveau Quiz Tactique' }}
                </h2>
        ...
        <Modal :show="showQuestionModal" @close="showQuestionModal = false">
            <div class="p-8 bg-gaming-darker border border-electric/20 rounded-[2.5rem] overflow-hidden relative max-h-[90vh] overflow-y-auto">
                ...
                <form @submit.prevent="submitQuestion" class="space-y-6 relative z-10">
                    <div class="space-y-2">
                        <label class="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-black ml-1">
                    ...
                    <div class="pt-4 flex gap-3">
                        ...
                        <NeonButton type="submit" class="flex-1" :disabled="questionForm.processing">
